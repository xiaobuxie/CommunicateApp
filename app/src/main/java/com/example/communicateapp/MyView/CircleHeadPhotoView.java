package com.example.communicateapp.MyView;
...
public class CircleHeadPhotoView extends androidx.appcompat.widget.AppCompatImageView{
    ...
    public CircleHeadPhotoView(Context context,AttributeSet attrs) {
        super(context,attrs);
    }
